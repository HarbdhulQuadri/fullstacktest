...
import { Migration1788784850379 } from '../migrations/1788784850379-Migration';
import { AddCitizenship1788785000000 } from '../migrations/1788785000000-AddCitizenship';
...
export default registerAs('database', (): TypeOrmModuleOptions => {
  const common = {
    ...
    migrations: [
      InitSchema1787228547499,
      AddTimestampDefaults1787229000000,
      Migration1788784850379,
      AddCitizenship1788785000000,
    ],
    logging,
  };
